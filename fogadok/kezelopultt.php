				...
				<div class='order-content'>
					<div>
						<div>
							...
							echo "</span>
							<span>Végösszeg: $vegosszeg $penznemk</span>
							<span>Fizetési mód: $fizetes</span>
							<span>Foglalási azonosító: $foglalasazon</span>
						</div>
						<div>
							<span>Ügyfél adatok</span>
							<span>Név: $nev</span>
							<span>Tel: $tel</span>
							<span>Szül. dátum: $szuldat</span>
							<span>Ennyi fő érkezik: $letszam</span>
						</div>
					</div>
				</div>
			</div>
	...
	if ($szamlalo1 == 0) {
		echo "<div class='order'>
				<div class='order-header-empty'>
					...
					<span>Nincsenek aktív foglalások... még!</span>
				</div>
			</div>";
	}
