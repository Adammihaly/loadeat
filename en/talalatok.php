...
<head>
    ...
    <title>Loadeat - Our restaurants</title>
...
<body>
    ...
    <header class="header">
        ...
        <p class="header-p">- Our apartment restaurants</p>
        <div class="header-form">
            <p class="header-form-p">Find the most perfect apartment restaurant for you:</p>
            <form  method="POST" action="../php/kereses.php">          
                <select type="text" name="helyseg" required="required" placeholder="Enter the location" class="form-text">
...
?>
                ...
                <input type="text" name="datum" required="required" class="form-date"  onfocus="(this.type='date')" placeholder="Choose a date" onblur="(this.type='text')">
                ...
                <button class="form-button" name="sub"><img src="../img/icons8-search-50.png" class="form-img-search"> Search</button>
            </form>
    ...
    <section class="main">
        ...
        if($foglat == 1)
        {
            ...
            <span class='foglalt'>Reserved</span>
            </a>
        </div>";
        }
        else
