...
<head>
	...
	<title>Loadeat • Control panel</title>
...
if (isset($_GET['error'])) {
        if ($_GET['error'] == "none") {
            ...
            if(confirm('The restaurant has been successfully published!')) document.location = 'kezelopultt';
...
if ($etteremID != null) {
	...
	<div class="buttons">
		<a href="https://loadeat.com">Homepage</a>
		<?php
