...
if (isset($_GET['f'])) {
        if ($_GET['f'] == 1) {
            ...
            if(confirm('Vaša rezervacija je bila neuspešna! Restoran je već bio rezervisan u dato vreme. Molimo izaberite drugi datum!')) document.location = 'etterem?eid=$etteremID';
    ...
    <main class="main">
                ...
                <div class="home-data-container-fullscreen container">
                    ...
                    <div class="home-data">
                        ...
                        <div class="home-description">
                            ...
                            <div class="home-box">
                                ...
                                <p class="home-data-p" id="etteremEmail">Kontakt je moguć preko sajta Loadeat
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="fullscreen-container grid">
                        ...
                        <div class="home-section-container-fullscreen container">
                            <h2 class="home-section-container-title">Informacije o restoranu:</h2>
                            <p class="home-section-container-description" id="etteremLeiras"><?php echo "$etteremleiras";?></p>
                            <h2 class="home-section-container-title">Opcije Plaćanja:</h1>
                                <ul class="home-section-container-ul">
                                    <?php

                                    if ($helykeszpenz == 1) {
                                        echo "<li class='home-section-container-list'><img src='../img/wallet.svg' alt='wallet'
                                            class='home-section-container-icon'> Plaćanje gotovinom na licu mesta</li>";
                                    }
                                    if ($helykartya == 1) {
                                        echo "<li class='home-section-container-list'><img src='../img/pay.svg' alt='pay'
                                            class='home-section-container-icon'> Plaćanje debitnim karticama na licu mesta</li>";
                                    }
                                ...
                                <?php
                                    ...
                                    echo "<button class='button foglalasBtn' id='foglalasBtn' onclick='showPopup()'>Rezervacija</button>";
                                ...
                                <a href="#menu"><button class="button">Prikaži menije</button></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="home-container grid">
                ...
                <div class="home-section-container container">
                    ...
                    <h2 class="home-section-container-title">Opcije Plaćanja:</h1>
                        ...
                        <button class="button foglalasBtn" id="foglalasBtn" onclick="showPopup()">Rezervacija</button>
                        <a href="#menu"><button class="button">Prikaži menije</button></a>
                </div>
            </div>
        </section>
        ...
        <section class="menu section container" id="menu">
            <div class="menu-side-container">
                <h1 class="menu-container-title">Meniji</h1>
                ...
                <div class="menu-section-container">
                    <div class="menu-container grid">
                        ...
                        <div class="menu-data">
                            ...
                            <p class="menu-price">Cena menija u različitim <br> valutama:
                    ...
                    <div id="popup" class="popup">
                        ...
                        <div class="container">
                            <form action="../php/foglalas.php" method="POST" id="foglaloFelForm">
                                ...
                                ?>
                                <h3 class="form-title">Rezervacija</h3>
                                <label for="">PAŽNJA! Ako imate profil gosta registrovan na našem sajtu, prijavite se na njega i onda napravite rezervaciju. Ako želite da napravite rezervaciju bez profila, to možete učiniti, u slučaju otkazivanja možete samo kontaktirati korisnički servis.</label><br><br>
                                <label for="">Ime kupca</label>
                                <input type="text" id="fname" name="fname" placeholder="Ime" required maxlength="100" minlength="5">
                                <label for="">Broj telefona kupca</label>
                                <input type="text" id="telnumber" name="telnumber" placeholder="06 30 123 4567" required maxlength="100">                             
                                <label for="">Datum rođenja kupca</label>
                                <input type="date" id="szulDatum" name="szulDatum" required>
                                <label for="">Broj klijenata</label>
                                <input type="number" id="foglalasFo" name="foglalasFo" required min="1" max="6">
                            
                                <h3 class="form-title">Detalji rezervacije</h3>
                                <label>Datum</label>
                                ...
                                <label>Broj prvog menija</label><input type="number" name="menu1" id="elsomenu" min="0" onchange="updateTotal()">
                                <label>Broj drugog menija</label><input type="number" name="menu2" id="masodikmenu" min="0" onchange="updateTotal()">
                                <label>Broj trećeg menija</label><input type="number" name="menu3" id="harmadikmenu" min="0" onchange="updateTotal()">
                            
                                <div class="checkboxInput">
                                    <input type="radio" id="bankCardPayment" name="fizetes" value="BankCard">
                                    <label for="bankCardPayment">Plaćanje gotovinom na licu mesta</label>
                                </div>

                                <div class="checkboxInput">
                                    <input type="radio" id="cashPayment" name="fizetes" value="Cash">
                                    <label for="cashPayment">Plaćanje debitnim karticama na licu mesta</label>
                                </div>
                                ...
                                <p class="total">Iznos:  <span id="totalPrice"></span></p>
                            <div style="text-align: center;">

                                <?php echo "<input type='hidden' name='lang' value='rs'>"; ?>
                                <button type="submit" name="sub" class="button">Rezervacija</button>
                            </div>
                            </form>
