...
<head>
    ...
    <title>Loadeat - Naši restorani</title>
...
<body>
    ...
    <header class="header">
        ...
        <p class="header-p">- Naši apartmanski restorani</p>
        <div class="header-form">
            <p class="header-form-p">Pronađi za sebe najsavršeniji apartman restoran:</p>
            <form  method="POST" action="../php/kereses.php">          
                <select type="text" name="helyseg" required="required" placeholder="Izaberite okrug / oblast" class="form-text">
...
?>
                ...
                <input type="text" name="datum" required="required" class="form-date"  onfocus="(this.type='date')" placeholder="Izaberi datum" onblur="(this.type='text')">
                ...
                <button class="form-button" name="sub"><img src="../img/icons8-search-50.png" class="form-img-search"> Traži</button>
            </form>
    ...
    <section class="main">
        ...
        if($foglat == 1)
        {
            ...
            <a href='etterem?eid=$EtteremID'><img src='../files/$kep' class='etterem-image'>
            <span class='foglalt'>Rezervisano</span>
            </a>
        </div>";
        }
        else
        {
            echo "<a href='etterem?eid=$EtteremID'><img src='../files/$kep' class='etterem-image'></a>";
        }
